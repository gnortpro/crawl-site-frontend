...
const IconBtn: React.FC<Props> = ({
  ...
  const loadIcon = iconType && (
    <CustomIcon type={iconType} mode={iconMode} size={iconSize} isIgnoreOutline={isIgnoreOutline} />
  );
  ...
  return (
    <button
      className={cx('iconButton', className, size, {
        loading: isLoading,
        'disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed shadow-none': !!disabled,
      })}
